...
public class Main {
	...
	private static void startBatchMode() throws IOException {
		...
		if(!_outFile.equals(null)){
			System.out.println("ya tenemos el nombre del fichero de salida");
			salida = new FileOutputStream(_outFile); //De un String generamos el OutputStream
		}
		else{
			System.out.println("creamos un nombre para el fichero de salida");
			salida = new FileOutputStream("examples/events/basic/"); //De null generamos el OutputStream
		}
		
		TrafficSimulator simulador = new TrafficSimulator(salida);
		Controller controlador = new Controller(simulador, _timeLimit, null, null);
